...
import 'package:star_menu/src/params/background_params.dart';
import 'package:star_menu/src/params/boundary_background.dart';
import 'package:star_menu/src/params/circle_shape_params.dart';
import 'package:star_menu/src/params/grid_shape_params.dart';
...
class StarMenuParameters {
  ...
  final LinearShapeParams linearShapeParams;
  ...
  /// Checks if the whole menu boundaries exceed screen edges,
  /// if so set it in place to be all visible
